# Operator Quickstart — Economic Regulation and Business Compliance Administration

Shortest path from clone to a verified local dry-run for **ISIC 8413** (`cloud-itonami-isic-8413`).
...
- Blueprint governor key: `regulation-governor`
- Likely source path: `regulation.governor.cljc`
